...
module "eks" {
  ...
  # Critical fix: explicitly disable control plane logs
  cluster_enabled_log_types = []

  # Do not create the corresponding CloudWatch log group
  create_cloudwatch_log_group = false

  # Optional safeguard: Do not retain logs long-term even if someone enables them in the future.
  cloudwatch_log_group_retention_in_days = 1

  # Critical fix: Do not enable Extended Support by default.
